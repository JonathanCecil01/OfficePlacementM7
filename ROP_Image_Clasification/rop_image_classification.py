...
def build_retinal_resnet_model(path):
  rop_classifier = Sequential()
  pre_trained = tf.keras.models.load_model(path)
  for layer in pre_trained.layers:
    layer.trainable = False
  rop_classifier.add(pre_trained)
  rop_classifier.add(Flatten())
  rop_classifier.add(Activation('relu'))
...
if __name__ == '__main__':
   path_to_images = "ROP_Image_Clasification/ROP_images"
   ...
   #classifier.save("CNN_classifier")
   classifier = build_retinal_resnet_model("Retinal_trained_resnet")
